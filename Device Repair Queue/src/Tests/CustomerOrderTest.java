...
class CustomerOrderTest  {
	 ...
	 @DisplayName("Tests output of toString method when option 1 is selected and customer name entered is 'John Boy'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(1, "John Boy");  //creating new CustomerOrder object for simulating a customer entry
	 ...
	 @DisplayName("Tests output of toString method when option 2 is selected and customer name entered is 'Василий - Vasily'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(2, "Василий - Vasily");  //creating new CustomerOrder object for simulating a customer entry
	 ...
	 @DisplayName("Tests output of toString method when option 3 is selected and customer name entered is 'Василий - Vasily'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(3, "Василий - Vasily");  //creating new CustomerOrder object for simulating a customer entry
	 ...
	 @DisplayName("Tests output of toString method when option 4 is selected and customer name entered is 'Janine'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(4, "Janine"); //creating new CustomerOrder object for simulating a customer entry
	 ...
	 @DisplayName("Tests output of toString method when option 5 is selected and customer name entered is 'Alice'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(5, "Alice"); //creating new CustomerOrder object for simulating a customer entry
	 ...
	 @DisplayName("Tests output of toString method when option 6 is selected and customer name entered is 'Joe'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(6, "Joe"); //creating new CustomerOrder object for simulating a customer entry
	...
	// @Test 
     @DisplayName("Tests output of toString method when option 1 is selected and customer name entered is 'John'")
	    ...
	    {
		 CustomerOrder customerOrderTester = new CustomerOrder(1, "John"); //creating new CustomerOrder object for simulating a customer entry
